...
app.frame('/', (c) => {
  ...
  return c.res({
    ...
    intents: [
      ...
      <Button.Link href="https://warpcast.com/0xhen/0x1a8b7737">🎁Daily</Button.Link>,
      <Button.Link href="https://warpcast.com/~/compose?text=Frame_By%20@0xhen&embeds[]=https://0xhen-frame-user.vercel.app/api">🔍Share</Button.Link>,
    ],
  })
})
